        ...
        <div className="sidebar_inner" data-simplebar="">
          <ul>
            ...
            <li id="more-veiw" hidden="">
              <a href="birthdays.html">
                ...
                <span> Birthdays </span> <span className="new">N</span>
              </a>
            </li>
            <li id="more-veiw" hidden="">
              <a href="fundraiser.html">
                ...
                <span> Fundraiser </span> <span className="new">N</span>
              </a>
            </li>
          </ul>
          <a
          ...
          <ul className="side_links" data-sub-title="Pages">
            <li>
              ...
              <ul>
                <li>
                  <a href="pages-setting.html">layout 1</a>
                </li>
                <li>
                  <a href="pages-setting2.html">layout 2</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="#">
                {" "}
                <ion-icon name="albums-outline" className="side-icon" />{" "}
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="create-page.html"> Create Page </a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              <a href="#">
                {" "}
                <ion-icon name="log-in-outline" className="side-icon" />{" "}
