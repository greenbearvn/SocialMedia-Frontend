          ...
          <div className="header_inner mcontainer">
            ...
            <div className="right_side">
              <div className="header_widgets">
                ...
                <div
                  uk-drop="mode: click"
                  className="header_dropdown dropdown_cart"
                >
                  ...
                  <ul className="dropdown_cart_scrollbar" data-simplebar="">
                    ...
                    <li>
                      ...
                      <div className="cart_text">
                        ...
                        <p className="text-sm">Type Parfums</p>
                      </div>
                      <div className="cart_price">
                        <span> $16.99 </span>
                        <button className="type"> Remove</button>
                    ...
                    <li>
                      ...
                      <div className="cart_text">
                        ...
                        <p className="text-sm">Type Herbel</p>
                      </div>
                      <div className="cart_price">
                        <span> $12.99 </span>
                        <button className="type"> Remove</button>
                    ...
                    <li>
                      ...
                      <div className="cart_text">
                        ...
                        <p className="text-sm">Type Furniture</p>
                      </div>
                      <div className="cart_price">
                        <span> $19.99 </span>
                        <button className="type"> Remove</button>
                    ...
                    <li>
                      ...
                      <div className="cart_text">
                        ...
                        <p className="text-sm">Type Fruit</p>
                      </div>
                      <div className="cart_price">
                        <span> $12.99 </span>
                        <button className="type"> Remove</button>
